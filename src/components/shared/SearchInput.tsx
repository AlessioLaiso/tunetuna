  ...
  return (
    <div className="relative">
      <input
        ...
        className={`w-full px-4 py-2 ${showClearButton && localValue ? 'pl-10 pr-10' : 'pl-10'} bg-zinc-900 border border-zinc-800 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[var(--accent-color)] focus:border-transparent`}
      />
      <svg
